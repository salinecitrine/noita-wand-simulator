...
const defaultPresets = [
  ...
  {
    //https://discord.com/channels/453998283174576133/626136067707240449/862120742836633612
  ...
  {
    name: 'scratch',
    wand: { ...defaultWand, deck_capacity: 26, actions_per_round: 3 },
    spells: [
      // 'HOMING_AREA',
      // 'BLOODLUST',
      'CLIPPING_SHOT',
  ...
  {
    name: 'scratch 2',
    wand: { ...defaultWand, deck_capacity: 15 },
    spells: [
      'BURST_3',
      'DIVIDE_10',
      'DIVIDE_10',
